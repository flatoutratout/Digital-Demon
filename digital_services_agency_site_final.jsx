...
export default function DigitalServicesAgencySite() {
  ...
  <div className="absolute inset-0 rounded-full bg-gradient-to-r from-transparent via-sky-400 to-transparent" />
            ...
            <button className="rounded-xl bg-white px-4 py-2 text-slate-900 font-semibold shadow-sm">
              Start Project
            </button>
          </div>
        </div>
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-16 px-6 pb-28 pt-12 lg:grid-cols-2">
          ...
          <motion.div {...fadeUp} className="relative">
            <div className="rounded-3xl bg-white/10 p-6 backdrop-blur border border-white/10 shadow-[0_30px_80px_rgba(2,6,23,0.5)]">
      ...
      <section className="bg-white border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-6 py-24 grid lg:grid-cols-2 gap-16">
          ...
          <motion.div {...fadeUp} className="border border-slate-200 rounded-3xl p-8 shadow-sm bg-slate-50/80 backdrop-blur">
